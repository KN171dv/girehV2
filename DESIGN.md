...
- **Arrow:** the solid and outline variants carry a drawn arrow that occupies no width at rest. On hover and `:focus-visible` its wrapper opens to 1.15em while the glyph slides in from -0.5rem, both over 420ms. The label, never the arrow, is what the button is read by.
