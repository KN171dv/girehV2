...
export function Menu() {
  ...
  return (
    <section
      ref={ref}
      id="servicos"
      className="relative overflow-hidden bg-carvao py-24 sm:py-32 lg:py-36"
    >
            ...
            <ul className="mt-12 border-t border-bronze/35">
              {SERVICES.map((service, index) => (
                <li
                  ...
                  className="group/row border-b border-bronze/35"
                >
                  ...
                  <div className="flex items-baseline justify-between gap-6 pb-6 pt-5 lg:py-7">
                    <div className="min-w-0">
                      ...
                      <div className="mt-2.5 flex items-center gap-5">
                        <span className="text-[0.82rem] text-osso/55">
                          {service.duration}
                        </span>
                        <WhatsAppButton
                          variant="quiet"
                    ...
                    <span className="shrink-0 font-display text-[1.5rem] text-latao sm:text-[1.75rem] lg:text-[2rem]">
